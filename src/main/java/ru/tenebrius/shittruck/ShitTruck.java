...
public class ShitTruck extends EntityHorse {
...
//        private static final String __OBFID = "CL_00001642";
        ...
        public boolean isEntityApplicable(Entity p_82704_1_) {
            return p_82704_1_ instanceof ShitTruck && ((ShitTruck) p_82704_1_).func_110205_ce();
        }
    };
...
//    private static final String[] field_110292_bC = new String[] {"", "wo_", "wmo", "wdo", "bdo"};
    ...
    public ShitTruck(World p_i1685_1_) {
        super(p_i1685_1_);
        ...
        this.tasks.removeTask(new EntityAIFollowParent(this, 1.0D));
        this.tasks.removeTask(new EntityAIWander(this, 0.7D));
        this.tasks.removeTask(new EntityAIWatchClosest(this, EntityPlayer.class, 6.0F));
...
//        return this.dataWatcher.getWatchableObjectByte(19);
    ...
    public boolean isTame() {
        return true;//this.getHorseWatchableBoolean(2);
    }

    public boolean func_110253_bW() {
        return true;//this.isAdultHorse();
    }
...
//    }
    ...
    protected ShitTruck getClosestHorse(Entity p_110250_1_, double p_110250_2_) {
...
//        }
        if (!this.isTame() && this.func_110256_cu()) {
            return false;
        } else if (this.isTame() && p_70085_1_.isSneaking()) {
    ...
    private void setSitsEntity(EntityPlayer entity) {
//        this.setEatingHaystack(false);
//        this.setRearing(false);
    ...
    public void onLivingUpdate() {
        ...
        if (!this.worldObj.isRemote) {
            ...
            if (this.func_110205_ce() && !this.isAdultHorse() && !this.isEatingHaystack()) {
                ShitTruck ShitTruck = this.getClosestHorse(this, 16.0D);

                if (ShitTruck != null && this.getDistanceSqToEntity(ShitTruck) > 4.0D) {
                    PathEntity pathentity = this.worldObj.getPathEntityToEntity(this, ShitTruck, 16.0F, true, false, false, true);
...
//            }
    ...
    public boolean canMateWith(EntityAnimal p_70878_1_) {
        if (p_70878_1_ == this) {
            ...
            ShitTruck ShitTruck = (ShitTruck) p_70878_1_;

            if (this.func_110200_cJ() && ShitTruck.func_110200_cJ()) {
                int i = this.getHorseType();
                int j = ShitTruck.getHorseType();
    ...
    public EntityAgeable createChild(EntityAgeable p_90011_1_) {
        return null;
        /*
        ShitTruck ShitTruck = (ShitTruck) p_90011_1_;
        ShitTruck ShitTruck1 = new ShitTruck(this.worldObj);
        int i = this.getHorseType();
        int j = ShitTruck.getHorseType();
        int k = 0;
        ...
        if (k == 0) {
            ...
            if (i1 < 4) {
                ...
                l = ShitTruck.getHorseVariant() & 255;
            } else {
            ...
            if (j1 < 2) {
                ...
                l |= ShitTruck.getHorseVariant() & 65280;
            } else {
                l |= this.rand.nextInt(5) << 8 & 65280;
            }

            ShitTruck1.setHorseVariant(l);
        }

        ShitTruck1.setHorseType(k);
        ...
        ShitTruck1.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(d1 / 3.0D);
...
//        ShitTruck1.getEntityAttribute(horseJumpStrength).setBaseValue(d2 / 3.0D);
        ...
        ShitTruck1.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(d0 / 3.0D);
        return ShitTruck1;
         */
    }
...
//        boolean flag = false;
        ...
        if (!(p_110161_1_1 instanceof ShitTruck.GroupData)) p_110161_1_1 = new ShitTruck.GroupData(l, i);
...
//            this.sitsEntity.setPosition(this.posX + (double) (f2 * f)+1F, this.posY * 2 + this.getMountedYOffset() + this.sitsEntity.getYOffset() + (double) f3 - 4F, this.posZ - (double) (f2 * f1));
//            if (this.sitsEntity instanceof EntityLivingBase) {
//                ((EntityLivingBase) this.sitsEntity).renderYawOffset = this.renderYawOffset;
//            }
//        }
        if(riddenByEntity != null) {
            float f = MathHelper.sin(this.renderYawOffset * (float) Math.PI / 180.0F);
            ...
            float f2 = 0.7F * this.prevRearingAmount;
            float f3 = 0.15F * this.prevRearingAmount;
            this.riddenByEntity.setPosition(this.posX + (double) (f2 * f), this.posY * 2 + this.getMountedYOffset() + this.riddenByEntity.getYOffset() + (double) f3 - 4F, this.posZ - (double) (f2 * f1));
